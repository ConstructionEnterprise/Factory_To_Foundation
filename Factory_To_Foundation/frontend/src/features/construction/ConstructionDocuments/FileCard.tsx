...
type FileCardProps = {
  file: ProjectFile;
  /** Real refetch trigger for the parent's list — this card never keeps its own copy of the authoritative row after a mutation, it just asks the parent to reload. */
  onChanged: () => void;
};

export default function FileCard({ file, onChanged }: FileCardProps) {
