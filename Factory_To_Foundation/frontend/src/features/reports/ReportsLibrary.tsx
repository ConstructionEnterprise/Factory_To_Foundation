...
/**
 * Real enterprise-wide document search (Phase 1C, 2026-08-15) — the
 * capability Reports previously had none of. Metadata/filename match only
 * (GET /construction-files/search), never full-text content search
 * (Phase 0 decision — explicitly deferred). Construction's own
